document.addEventListener("DOMContentLoaded", function() {
    ...
    peer.on("open", function(id) {
        // ive got my peerID and serverID, lets send it to the server to join
        setTimeout(function() { // wait to make sure socket.io is established TODO: better solution plz
            console.log("emit a join", {peerID: id, serverID: serverID});
            socket.emit("join", {peerID: id, serverID: serverID});
        },500);
    });
